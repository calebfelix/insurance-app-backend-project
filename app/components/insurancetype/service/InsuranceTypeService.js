...
const { parseLimitAndOffset, parseFilterQueries } = require('../../../utils/request');
    ...
    async getAllInsuranceType(settingsConfig, queryParams) {
        ...
        try {
          const selectArray = {
            ...
            insuranceName: insuranceTypeConfig.fieldMapping.insuranceName,
          ...
          const logger = settingsConfig.logger;
          logger.info(`[InsuranceType_SERVICE] : Inside getAllInsuranceType`);
